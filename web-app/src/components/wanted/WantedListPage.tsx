    ...
    <div className="max-w-2xl mx-auto px-2 sm:px-4 pt-1 pb-16 text-left animate-in fade-in duration-150 relative">
      ...
      <div className="sticky top-1 sm:top-2 z-40 flex items-center justify-between pointer-events-none mb-3 py-1">
        ...
        <button
          ...
          className="pointer-events-auto inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-[#732729] hover:bg-[#5a1e20] active:scale-95 text-white text-xs font-bold rounded-full transition-all shadow-sm cursor-pointer select-none"
        >
      ...
      <div className="bg-white rounded-2xl p-3.5 sm:p-4 border border-[#bc8381]/25 shadow-2xs mb-3.5">
        <div className="flex items-center justify-between gap-2 mb-2.5">
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded-full bg-[#732729]/10 text-[#732729] text-[11px] font-bold">
              {items.length} looks
            </span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-8 py-1.5 bg-[#faf6f5] border border-[#bc8381]/25 rounded-xl text-xs font-medium text-stone-800 focus:outline-none focus:ring-1 focus:ring-[#732729]/50 placeholder-stone-400 transition-all"
            />
            {search && (
              <button
                type="button"
              ...
              return (
                <button
                  ...
                  className={`px-3 py-0.5 rounded-full text-[11px] font-bold transition-all cursor-pointer whitespace-nowrap active:scale-95 ${
                    isSelected
                      ? 'bg-[#732729] text-white shadow-2xs'
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -8 }}
            className="fixed top-12 left-1/2 -translate-x-1/2 z-50 bg-[#732729] text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg flex items-center gap-1.5 select-none"
          >
      ...
      <div className="bg-white rounded-3xl p-3 sm:p-5 border border-[#bc8381]/25 shadow-2xs divide-y divide-stone-100">
              ...
              >
                ...
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-xs sm:text-[13.5px] font-bold text-stone-900 leading-snug group-hover:text-[#732729] transition-colors truncate">
                      {item.name}
                    </h3>
        ...
        {isRequestModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div
              ...
              className="bg-white rounded-3xl p-5 sm:p-6 max-w-md w-full border border-[#bc8381]/25 shadow-2xl text-left relative overflow-hidden"
            >
              <div className="flex items-start justify-between gap-3 mb-4">
                <div>
                  <h3 className="text-base sm:text-lg font-serif font-bold text-[#732729]">
              ...
              <form onSubmit={handleCreateRequest} className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs px-3.5 py-2 border border-[#bc8381]/35 rounded-xl font-semibold text-stone-800 bg-[#faf6f5] focus:outline-none focus:ring-1 focus:ring-[#732729]/50"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs bg-[#faf6f5] border border-[#bc8381]/35 rounded-xl px-2.5 py-2 font-semibold text-stone-800 focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs px-3.5 py-2 border border-[#bc8381]/35 rounded-xl font-semibold text-stone-800 bg-[#faf6f5] focus:outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 bg-[#faf6f5] p-2 border border-[#bc8381]/25 rounded-xl">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full text-xs px-3.5 py-1.5 border border-[#bc8381]/35 rounded-xl font-medium text-stone-800 bg-[#faf6f5] focus:outline-none"
                  />
                </div>
                ...
                <div className="pt-1 flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 py-2.5 bg-[#732729] hover:bg-[#5a1e20] text-white text-xs font-bold rounded-xl transition-all shadow-xs cursor-pointer flex items-center justify-center gap-1.5"
                  >
